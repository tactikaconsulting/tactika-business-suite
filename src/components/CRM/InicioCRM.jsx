...
function MiniCard({ icon: Icon, label, valor, detalle, variante = "default" }) {
  ...
  return (
    <div className={`rounded-lg border p-4 ${oscuro ? "bg-slate-900 border-slate-900 text-white" : "bg-white border-slate-200 text-slate-800"}`}>
      ...
      <p className="mt-1 text-2xl font-bold font-mono">{valor}</p>
    </div>
  );
}
...
function ListaSimple({ titulo, vacio, items, renderItem, accion }) {
  return (
    <section className="bg-white border border-slate-200 rounded-xl p-5 min-h-[220px]">
      ...
      <section className="bg-white border border-slate-200 rounded-xl p-5">
        <div className="flex items-start justify-between gap-4 flex-wrap">
          <div>
            ...
            <h2 className="text-2xl font-bold text-slate-800 mt-1">Resumen comercial del dia</h2>
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <button
              ...
              className="px-3 py-2 rounded-lg border border-blue-200 bg-blue-50 text-sm font-semibold text-blue-700 hover:bg-blue-100"
            >
              Ver propuestas
            </button>
          </div>
            ...
            <div key={prospecto.id} className="border border-amber-200 bg-amber-50 rounded-lg p-3">
              <div className="flex items-start justify-between gap-3">
                ...
                <button
                  ...
                  className="px-3 py-1.5 rounded-md border border-amber-200 bg-white text-xs font-semibold text-amber-700 hover:bg-amber-100 flex items-center gap-1"
                >
            ...
            <div key={prospecto.id} className="border border-slate-200 rounded-lg p-3">
              <div className="flex items-start justify-between gap-3">
                ...
                <button
                  ...
                  className="px-3 py-1.5 rounded-md border border-blue-200 bg-blue-50 text-xs font-semibold text-blue-700 hover:bg-blue-100"
                >
                  Propuesta
                </button>
              </div>
